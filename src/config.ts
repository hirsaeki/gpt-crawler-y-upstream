...
export const configSchema = z.object({
  ...
  onVisitPage: z
    ...
    .args(
      z.object({
        ...
        visitPageWaitTime: z.number().int().positive().optional(),
      }),
    )
  ...
  waitTime: z.number().int().positive().optional(),

  /**
   * Only crawl links inside the specified selector
   * @default false
   */
  crawlInsideSelector: z.boolean().optional(),
});
